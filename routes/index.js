...
const CreateGroup = lazy(() => import('../pages/protected/CreateGroup')); // to be removed
const AnnualCheckup = lazy(() => import('../pages/protected/AnnualCheckup'));
const AnnualCheckupList = lazy(() => import('../pages/protected/AnnualCheckupList'));
...
const routes = [
	...
	{
		path: '/checkup/annual',
		component: AnnualCheckup,
	},
	{
		path: '/checkup/list',
		component: AnnualCheckupList,
	},
];
