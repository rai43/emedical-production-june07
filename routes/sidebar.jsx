...
import { TbCheckupList } from 'solid-icons/tb';
import { TbCalendarTime } from 'solid-icons/tb';
...
if (profil_type === 'MEDECIN') {
	routes = [
		...
		{
			path: '', //no url needed as this has submenu
			icon: <TbCheckupList class={`${iconClasses} inline`} />, // icon component
			name: 'Bilans', // name that appear in Sidebar
			submenu: [
				{
					path: '/app/checkup/annual', //url
					icon: <TbCalendarTime class={submenuIconClasses} />, // icon component
					name: 'Bilan Annuel', // name that appear in Sidebar
				},
				{
					path: '/app/users/create',
					icon: <BiRegularUserPlus class={submenuIconClasses} />,
					name: 'Bilan spécifique',
				},
				{
					path: '/app/groups/manage',
					icon: <BiRegularUserPlus class={submenuIconClasses} />,
					name: "Bilan d'embauche",
				},
				{
					path: '/app/checkup/list',
					icon: <BiRegularUserPlus class={submenuIconClasses} />,
					name: 'Liste examens bilan annuel',
				},
			],
		},
		{
