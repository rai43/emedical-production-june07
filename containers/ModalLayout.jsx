...
import AnnualCheckupAdd from '../features/annualCheckup/components/AnnualCheckupAdd';
		...
		<>
			...
			<div class={`modal ${modalState.isOpen ? 'modal-open' : ''}`}>
				<div class={`modal-box  ${modalState.size === 'lg' ? 'max-w-5xl' : ''}`}>
					...
					<Show when={modalState.bodyType === GLOBAL_CONSTANTS.MODAL_BODY_TYPES.ANNUAL_CHECKUP_NEW}>
						<AnnualCheckupAdd onCloseModal={close} />
					</Show>
				</div>
			</div>
		</>
